...
class ModeloLibros{
	...
	static public function mdlEditarLibro($tabla, $datos){
		...
		$stmt = Conexion::conectar()->prepare("UPDATE $tabla SET nombreLibro = :nombreLibro, descripcionLibro = :descripcionLibro, fotoLibro = :fotoLibro, idCategoria = :idCategoria, idAutor = :idAutor WHERE idLibro = :idLibro");
